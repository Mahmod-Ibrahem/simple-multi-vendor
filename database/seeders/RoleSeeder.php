...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $superAdminRole = Role::firstOrCreate(['name' => 'مدير النظام', 'guard_name' => 'api']);
        $adminRole = Role::firstOrCreate(['name' => 'مشرف', 'guard_name' => 'api']);
        $clientRole = Role::firstOrCreate(['name' => 'عميل', 'guard_name' => 'api']);
        ...
        // Client (عميل) gets read-only access to letters module
        ...
        $this->command->info('✓ Client (عميل): assigned ' . count($clientPermissionNames) . ' permissions (read-only)');
    }
}
